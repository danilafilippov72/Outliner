...
/***/ "./src/scripts/Front-end/Modules/treeNodeModule.js":
/*!*********************************************************!*\
  !*** ./src/scripts/Front-end/Modules/treeNodeModule.js ***!
  \*********************************************************/
...
/* harmony export */   "getNodeByTabId": () => (/* binding */ getNodeByTabId),
/* harmony export */   "getId": () => (/* binding */ getId),
/* harmony export */   "fadeTreeNode": () => (/* binding */ fadeTreeNode),
/* harmony export */   "treeNodeChildren": () => (/* binding */ treeNodeChildren),
/* harmony export */   "treeNodeNOChildren": () => (/* binding */ treeNodeNOChildren),
/* harmony export */   "treeNodeParent": () => (/* binding */ treeNodeParent),
/* harmony export */   "treeNodeParentStructure": () => (/* binding */ treeNodeParentStructure),
/* harmony export */   "treeNodeChild": () => (/* binding */ treeNodeChild),
/* harmony export */   "addingListenerToTreeNode": () => (/* binding */ addingListenerToTreeNode),
/* harmony export */   "Tab": () => (/* binding */ Tab),
/* harmony export */   "TreeNodeActive": () => (/* binding */ TreeNodeActive)
/* harmony export */ });
...
var TreeNodeActive = /*#__PURE__*/function () {
...
"use strict";
/*!*****************************************!*\
  !*** ./src/scripts/Front-end/struct.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Modules/treeNodeModule */ "./src/scripts/Front-end/Modules/treeNodeModule.js");
  ...
  function createTreeHierarchy() {
    ...
    function addListenersToTreeNodes() {
      Array.from(document.getElementsByClassName('treeNode')).forEach(function (treeNode) {
        return _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.addingListenerToTreeNode(treeNode);
      });
    }
  }
...
function Main() {
  ...
  function saveData(treeNode) {
    ...
    function dataSaving(treeNode) {
      if (_Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.treeNodeNOChildren(treeNode)) return {};
      var data = {};
      Array.from(_Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.treeNodeChildren(treeNode)).forEach(saveTreeNodeInfo);
  ...
  function addListenerToKeyDown(event) {
    if (event.key == 'q' && event.ctrlKey) {
      Array.from(document.getElementsByClassName('treeNode')).forEach(function (element) {
        var treeNode = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + element.id);
  ...
  function removeTreeNode(treeNode) {
    chrome.tabs.remove(_Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.getId(treeNode));

    if (!_Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.treeNodeNOChildren(treeNode)) {
      var treeNodeParentStructure = _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.treeNodeParentStructure(treeNode);
      Array.from(_Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.treeNodeChildren(treeNode)).forEach(function (treeNode) {
...
function changesTabOrWindow(tab) {
  if (tab.purpose == "create") {
    if (_Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.getNodeByTabId(tab.id) == null) addTreeNode(tab, tab.isWindow, tab.lastTreeNode);
  } else if (tab.purpose == "change") {
    _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.getNodeByTabId(tab.id).querySelector('.font').textContent = tab.title;
  ...
  function addTreeNode(tabOpen) {
    ...
    var tab = new _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.Tab(tabOpen);
    var tabParentNode = new _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.TreeNodeActive(treeMainNode);
    ...
    _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.addingListenerToTreeNode(tabParentNode.treeNode);
    _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.addingListenerToTreeNode(_Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.treeNodeChild(tabParentNode.treeNode));
  }

  function makeTabFaded(tab) {
    var treeNode = _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.getNodeByTabId(tab.id);
    _Modules_treeNodeModule__WEBPACK_IMPORTED_MODULE_2__.fadeTreeNode(treeNode);
  }
}
})();
